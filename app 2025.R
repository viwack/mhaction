...
lara_df <- read_csv("Michigan_MHCs_2025_with_lara_coords.csv") # Updated Data: I can get this on CTAC Drive -> reformat as Vicky's / (Lat,Long) Location Address, use R package to find the corresponding lat/long
